...
so you may need to momentarily remove the CD or place the hard disk before the
CD-ROM drive in the boot sequence in order for the system to boot properly.)
...
You can add additional *administrative* users -- NOT customers -- with this
command:
